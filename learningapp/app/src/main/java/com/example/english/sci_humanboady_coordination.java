...
public class sci_humanboady_coordination extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sci_humanboady_coordination);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                r++;
                if (i==8) {
                    Intent intent=new Intent(sci_humanboady_coordination.this,Science_Lessons.class);
