...
public class sci_humanboady_excertion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sci_humanboady_excertion);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                r++;
                if (i==10) {
                    Intent intent=new Intent(sci_humanboady_excertion.this,Science_Lessons.class);
