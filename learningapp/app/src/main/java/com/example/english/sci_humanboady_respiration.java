...
public class sci_humanboady_respiration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sci_humanboady_respiration);
        ...
        button_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                r++;
                if (i==6) {
                    Intent intent=new Intent(sci_humanboady_respiration.this,Science_Lessons.class);
