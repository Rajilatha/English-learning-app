...
public class WordSearchActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!res.isEmpty()) {
                    ...
                    if (gameBoard.getScore() == gameBoard.getMaxScore()) {
                        Intent intent = new Intent(mContext, EndGame1.class);
        ...
        words = Arrays.asList("Apartment", "Deposit","Former", "Huge", "Magnet", "Nest","Waves", "Virtual","Heart");
