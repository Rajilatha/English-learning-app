...
public class WordSearchActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!res.isEmpty()) {
                    ...
                    if (gameBoard.getScore() == gameBoard.getMaxScore()) {
                        Intent intent = new Intent(mContext, com.example.english.EndGame2.class);
        ...
        words = Arrays.asList("Carriage", "Pitch", "Invisible", "Perdition", "Permit", "Nervous","Appal", "Tangle","Swing");
