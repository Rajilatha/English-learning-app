...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public List<word> getAllPlants(){
        ...
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='noun'",null);
        if(c.moveToFirst()){
            do{
    ...
    public List<word> getAllFactors(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='adj'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllProducts(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='ver'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllImportance(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='adve'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllDigestion(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='pre'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllRespiration(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='con'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllExcretion(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='art'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllCirculation(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='ten'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllCoordination(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='ph'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllLevels(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='id'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllEcosystems(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='sen'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllPollution(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='sho'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllLifestyle(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='sha'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
    ...
    public List<word> getAllDevelopment(){
        List<word> questionList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor c = db.rawQuery("SELECT * FROM lesson where type ='to'",null);
        if(c.moveToFirst()){
            do{
                word question = new word();
                question.setName(c.getString(1));
